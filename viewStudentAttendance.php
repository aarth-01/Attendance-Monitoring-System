                    ...
                    if(isset($_POST['view'])){
                       ...
                       if ($type == "3") { // Date Range Attendance
                        ...
                        $query = "SELECT attendance.Id, attendance.status, attendance.dateTimeTaken, class.className,
                            ...
                            INNER JOIN term ON term.Id = sessionterm.termId
                            INNER JOIN students ON students.admissionNumber = attendance.admissionNo
                            WHERE attendance.dateTimeTaken BETWEEN '$fromDate' AND '$toDate' 
                            AND attendance.admissionNo = '$admissionNumber' 
                            AND attendance.classId = '$_SESSION[classId]' 
                            AND attendance.classDivId = '$_SESSION[classDivId]'"; // Fixed table name
