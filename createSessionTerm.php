...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from sessionterm where sessionName ='$sessionName' and termId = '$termId'");
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($conn,"insert into sessionterm(sessionName,termId,isActive,dateCreated) value('$sessionName','$termId','0','$dateCreated')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        $query=mysqli_query($conn,"select * from sessionterm where Id ='$Id'");
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update sessionterm set sessionName='$sessionName',termId='$termId',isActive='0' where Id='$Id'");
  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        ...
        $query = mysqli_query($conn,"DELETE FROM sessionterm WHERE Id='$Id'");
  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "activate")
	{
        ...
        $query=mysqli_query($conn,"update sessionterm set isActive='0' where isActive='1'");

            if ($query) {
                
                $que=mysqli_query($conn,"update sessionterm set isActive='1' where Id='$Id'");
            ...
            <div class="col-lg-12">
                      ...
                      <input type="text" class="form-control" name="sessionName" value="<?php echo $row['sessionName'];?>" id="exampleInputFirstName" placeholder="Session">
                        ...
                        <div class="col-xl-6">
                            <label class="form-control-label">Term<span class="text-danger ml-2">*</span></label>
                              <?php
                        $qry= "SELECT * FROM term ORDER BY termName ASC";
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT sessionterm.Id,sessionterm.sessionName,sessionterm.isActive,sessionterm.dateCreated,
                      term.termName
                      FROM sessionterm
