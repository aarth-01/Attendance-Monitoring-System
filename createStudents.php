...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"insert into students(firstName,lastName,admissionNumber,classId,classDivId,dateCreated) 
    value('$firstName','$lastName','$admissionNumber','$classId','$classDivId','$dateCreated')");
